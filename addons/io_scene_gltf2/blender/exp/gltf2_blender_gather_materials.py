...
def __gather_shadow_texture(blender_material, export_settings):
    shadow = gltf2_blender_get.get_socket(blender_material, "Shadow")
    if shadow is None:
        shadow = gltf2_blender_get.get_socket_old(blender_material, "Shadow")
    return gltf2_blender_gather_texture_info.gather_texture_info(shadow, (shadow,), export_settings)
